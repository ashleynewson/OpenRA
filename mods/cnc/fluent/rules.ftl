...
label-cnc-map-generator-choice-terrain-type-oceanic = Oceanic
label-cnc-map-generator-choice-terrain-type-large-islands = Large Islands
label-cnc-map-generator-choice-terrain-type-continents = Continents
label-cnc-map-generator-choice-terrain-type-wetlands = Wetlands
label-cnc-map-generator-choice-terrain-type-narrow-wetlands = Narrow Wetlands
