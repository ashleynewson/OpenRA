...
label-ra-map-generator-terrain-feature-size = Terrain feature size
label-ra-map-generator-forest-feature-size = Forest feature size
label-ra-map-generator-resource-feature-size = Resource feature size
...
label-ra-map-generator-maximum-expansion-mines = Expansion mines per symmetry
